...
public class SpringIntegrationConfig {
    ...
    public FileReadingMessageSource fileReadingMessageSource() {
        ...
        readder.setDirectory(new File("C:\\Users\\pc\\Desktop\\SpringProject"));
    ...
    public FileWritingMessageHandler fileWritingMessageHandler() {
        FileWritingMessageHandler writter = new FileWritingMessageHandler(new File("C:\\Users\\pc\\Desktop\\Destination"));
